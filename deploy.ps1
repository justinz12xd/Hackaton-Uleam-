...
gcloud services enable run.googleapis.com --project=$ProjectId 2>$null
gcloud services enable cloudbuild.googleapis.com --project=$ProjectId 2>$null
gcloud services enable containerregistry.googleapis.com --project=$ProjectId 2>$null
...
gcloud builds submit --tag $imageName --project=$ProjectId --region=$Region
